...
def posterior(x, n, P, Pr):
    """
    Posterior is a function that calculates the posterior probability
    """
...
def marginal(x, n, P, Pr):
    ...
    probability of obtaining that data in the Bayesian network P
    ...
    Args:
        ...
        Pr ([type]): pr is a 1D numpy.ndarray containing
